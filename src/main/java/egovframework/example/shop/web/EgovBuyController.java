...
public class EgovBuyController {
	 ...
	 */
	  ...
	  public String addBuy(@ModelAttribute("searchVO") ShopDefaultVO searchVO,
	  ShopVO shopVO, BindingResult bindingResult, Model model, SessionStatus status) throws Exception {
